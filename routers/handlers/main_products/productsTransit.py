...
from functions.func import get_products_status_in_transit

router = Router()

@router.callback_query(F.data == "transit")
async def main(callback: CallbackQuery):
    telegram_chat_id = callback.message.chat.id
    response = await get_products_status_in_transit(telegram_chat_id=telegram_chat_id)
